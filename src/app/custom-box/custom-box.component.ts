...
export class CustomBoxComponent {
  resumeData = {
    summary:
      "Full-stack developer with 4+ years building data tools and REST APIs at scale. Experienced with Java/Spring, Angular, Python, and SQL Server. Passionate about developer tooling and open-source — creator of Clara Coder, an agentic coding harness for local LLMs.",
    experiences: [
      {
    ...
    skills: [
      ...
      {
        category: "Backend:",
        items: "Spring Framework, Microservices, RESTful APIs, Node.js",
      },
      {
        category: "Frontend:",
        items: "Angular, HTML/CSS, Bootstrap 5, jQuery",
      },
      {
        category: "Database:",
        items: "SQL Server, PostgreSQL, data modeling and conversion",
      },
      {
        category: "Tools:",
        items:
          "Git, Linux, Electron, Selenium, Playwright, Langchain, Langgraph",
      },
    ],
  };
}
